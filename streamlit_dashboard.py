...
def _risk_inputs_from_predictions(
X_test: pd.DataFrame,
...
“”“Detect whether the dataframe is raw logs or already-engineered features.”””
...
with st.spinner("⚠️ Calculating risk score..."):
    risk_inputs = _risk_inputs_from_predictions(
        X_test=X_test,
